...
WORK_ORGANISATION_REGEXPS = [
    ...
    # Sometime declarants are ignorant enough and do write both office and position in
    # workPost field. To cover those cases we've added here extra classifiers
    ('workPost', r'судов.*експерт', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'\sсуд$', 'Суд'),
    ('workPost', r'\sсуд\s', 'Суд'),
    ('workPost', r'прокуратур', 'Прокуратура'),
    ('workPost', r'адмін.*президента', 'Адміністрація / Секретаріат Президента'),
    ('workPost', r'рнбо', 'Адміністрація / Секретаріат Президента'),
    ('workPost', r'рад.*нац.*безпек', 'Адміністрація / Секретаріат Президента'),
    ('workPost', r'^удо\s', 'Адміністрація / Секретаріат Президента'),
    ('workPost', r'^упр.{0,10}держ.{0,8}охор', 'Адміністрація / Секретаріат Президента'),
    ('workPost', r'держ.{0,8}упр.{0,10}справ', 'Адміністрація / Секретаріат Президента'),
    ('workPost', r'верх.{0,7}рад[а|и]', 'Парламент'),
    ('workPost', r'нац.{0,12}банк', 'НБУ'),
    ('workPost', r'\sнбу\s', 'НБУ'),
    ('workPost', r'^нбу$', 'НБУ'),
    ('workPost', r'\sнбу$', 'НБУ'),
    ('workPost', r'центр.{0,8}виб.{0,6}коміс', 'ЦВК'),
    ('workPost', r'(?:обл|рай|міськ).{0,6}держ.{0,6}адмін', 'Місцеві адміністрації та ради'),
    ('workPost', r'районн(?:а|ої) адмін', 'Місцеві адміністрації та ради'),
    ('workPost', r'кмда', 'Місцеві адміністрації та ради'),
    ('workPost', r'обласн(?:а|ої) адмін', 'Місцеві адміністрації та ради'),
    ('workPost', r'(?:обл|рай).{0,7}рад[а|и]', 'Місцеві адміністрації та ради'),
    ('workPost', r'рай.{0,6}[у|в] м.{0,6}\s.*\sрада', 'Місцеві адміністрації та ради'),
    ('workPost', r'рда|\sода', 'Місцеві адміністрації та ради'),
    ('workPost', r'міськ.{0,4}рад[а|и]', 'Місцеві адміністрації та ради'),
    ('workPost', r'сіль.{0,7}рад[а|и]', 'Місцеві адміністрації та ради'),
    ('workPost', r'селищ.{0,5}рад[а|и]', 'Місцеві адміністрації та ради'),
    ('workPost', r'\sсбу\s', 'СБУ'),
    ('workPost', r'^сбу$', 'СБУ'),
    ('workPost', r'\sсбу$', 'СБУ'),
    ('workPost', r'усбу', 'СБУ'),
    ('workPost', r'служб[а|и] безпеки укр', 'СБУ'),
    ('workPost', r'пенс.*фонд', 'Пенсійний фонд'),
    ('workPost', r'пфу', 'Пенсійний фонд'),
    ('workPost', r'\sпф\s', 'Пенсійний фонд'),
    ('workPost', r'^пф\s', 'Пенсійний фонд'),
    ('workPost', r'\sпф$', 'Пенсійний фонд'),
    ('workPost', r'фонд.*держ.*майн', 'Фонд державного майна'),
    ('workPost', r'каб.*мін', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'міністерство', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*агро', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'інсп.*сіль.*госп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'в.т.р.н.* служ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*ліс.*рес', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аге.*риб.*госп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*внутр.*справ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мвс', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'нац.*гвард', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'держ.*служ.{2,4}охор', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'гу\s?нп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'поліц', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'прикордон.*(?:служ|заг)', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'міграц', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'надзвич', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'(?:акад|унів).*внутр.*справ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*природ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'екол.*інсп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'служ.*геол', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*вод.*рес', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*екол.*інвест', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*упр.*зон.*в.{0,3}чу', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'прир.*(?:парк|запов)', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'дфс', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'фіск.*служ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'податк', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*доход', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'одпі', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'митн', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*енерг', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мзс', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*закордон', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'сан.*п.д.м', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'\sмоз\s', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'^моз\s', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'\sмоз$', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'^моз$', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*інфр', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*трансп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'адм.*мор.*порт', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'залізниця', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'авіа*служб', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'без.*(?:мор|назем).*трансп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аген.*туризм', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аген.*авто.*дор', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мінкульт', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'міністер.*культ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аген.*кіно', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'народ.*творч', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'(?:культур|істор).*запов.дник', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'музей', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'(?:худож|музич).*учил', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'учил.*культур', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'б.бл.отек', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'ф.лармон', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'театр', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'оркестр', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*спорт', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*обор', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'ген.*штаб', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'збр.*сил', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*осв.*наук', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'навч.*закл', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'\sмін.*рег', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'^мін.*рег', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*лектрон.*ряд', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*нерго', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*нов.*донбас', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'арх.*буд.*нсп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'служ.*гео.*карт', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'мін.*соц.*пол', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'фонд.*соц.*зах.*інв', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'інсп.*прац', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'служ.*інвал.*ветер', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'фонд.*соц.*страх', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'держ.*служ.*за.?нят', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'\sмін.*фін', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'^мін.*фін', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'\sмін.*юст', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'^мін.*юст', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'управ.*юст', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'пен.т.*служ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'виконав.*служ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'ре.*стра.*служ', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'зах.*персон.*дан', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'держ.*прац', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'вищ.*рад.*(?:юстиц|правосуд)', 'Вища рада юстиції'),
    ('workPost', r'казнач.*служ', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'упр.*казнач', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'держ.*служ.*стат', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'управ.*стат', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'упр.*статист', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'відділ.*статистик', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'сзр', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'амку|монопол', 'Антимонопольний комітет'),
    ('workPost', r'ком.*теле', 'Державний комітет телебачення і радіомовлення'),
    ('workPost', r'інсп.*цін', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'інсп.*спож', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'держ.*спож.*служ', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'вет.*фіто.*служ', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'сан.*епід.*служб', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'інсп.*ядер', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'регулят.*служ', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'експорт.*контр', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'служ.*наркот', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'інт.*влас', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'служ.*ветеран', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'держ.*фін.*інсп', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'гео.*кадас', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'корупц.*бю', 'НАБУ'),
    ('workPost', r'набу', 'НАБУ'),
    ('workPost', r'нац*аг*зап*корупц', 'НАЗК'),
    ('workPost', r'назк', 'НАЗК'),
    ('workPost', r'фін.*монітор', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'ком.*ц.*п.*фонд', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'нкцпфр', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'дмс', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'центр.*держ.*істор.*архів', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'держ.*арх.в.*служб', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'військ.*частин', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'в/ч', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'дснс', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'служ.*спец.*зв.*зах', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'служ.*посеред.*мир', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'держ.*спец.*зв', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'дксу', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'рахунк.*палат', 'Рахункова палата'),
    ('workPost', r'дпі', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'аг.*резерв', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'косм.*аген', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'ком.*нерг.*ком.*посл', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'нкрекп', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'ком.*зв.*інф.*зац', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'регул.*ринк.*фін.*посл', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'євро.*12', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'міністер.*економ.*розв', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'безп.*харч.*прод', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'держ.*спец.*служ.*трансп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'служб.*безп.*трансп', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'управ.*ветеринар.*мед', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'\sнп\s', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'держ.*аудит.*служб', 'Інші державні служби, комісії, і т.п.'),
    ('workPost', r'упр.*прац.*соц.*зах.*нас', 'Місцеві адміністрації та ради'),
    ('workPost', r'держ.*риб.*аг', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'упр.*охор.*вод.*риб', 'Кабмін, міністерства та підлеглі органи'),
    ('workPost', r'лісов.*госп', 'Кабмін, міністерства та підлеглі органи'),
]
